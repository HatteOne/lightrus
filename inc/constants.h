...
const QString text_ui_label_welcome_ss            = QString::fromUtf8("<H2>Добро пожаловать в программу русификации Adobe Photoshop Lightroom 2.x</H2>Данная программа позволит заменить один из дополнительных языков приложения Adobe Photoshop Lightroom на русский.<br><br>Версия русификатора: %1<br>Версия словаря: %2<br><br>Автор: Сергей Балякин");
...
const QString text_ui_label_welcome_ss            = QString::fromUtf8("<H2>Добро пожаловать в программу русификации Adobe Photoshop Lightroom 2.x</H2>Данная программа позволит добавить русский язык в Lightroom в качестве дополнительного.<br><br>Версия русификатора: %1<br>Версия словаря: %2<br><br>Автор: Сергей Балякин");
